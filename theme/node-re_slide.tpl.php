  ...
  <div id="dc-container">
    ...
    <div id="wrapper">
      ...
      <div id="navigation">
        <?php
        // Primary Links
        if(!empty($primary_links)) { print theme('links', $primary_links, array('class' => 'links primary-links')) . chr(10); }
      ...
      <div id="bd"<?php print $layout_class_attribute; ?>>
        <?php if(!empty($breadcrumb)) { print '<div id="breadcrumb">'. $breadcrumb .'</div>'. chr(10); } // Breadcrumb ?>
        <div class="dc-main">
          <div class="dc-div">
            <div id="utilities">
              <div id="text_size">
                <?php print t('Text size');?>: 
                <a href="#" id="small-text"><?php print t('Small Text'); ?> -</a> 
                <a href="#" id="large-text"><?php print t('Large Text'); ?> +</a>
              </div>
              <script type="text/javascript" src="http://w.sharethis.com/button/sharethis.js#publisher=4e1667cf-8007-473e-96b5-3eda0d97f1fb&amp;type=website&amp;post_services=facebook%2Cmyspace%2Cgbuzz%2Ctwitter%2Cdigg%2Csms%2Cwindows_live%2Cdelicious%2Cstumbleupon%2Creddit%2Cgoogle_bmarks%2Clinkedin%2Cbebo%2Cybuzz%2Cblogger%2Cyahoo_bmarks%2Cmixx%2Ctechnorati%2Cfriendfeed%2Cpropeller%2Cwordpress%2Cnewsvine&onmouseover=false"></script>  
            </div><!-- /utilities -->
