...
Drupal.behaviors.re_jquerytools_tabs = function(context) {
  // Get the selector:
  var $viewItems = $('#block-views-re_contextlibraries-block_1 .view-display-id-block_1 > .view-content > ul > li');
  ...
  $('#re_contextlibraries-view-display-id-block_1-navigation')
    .tabs($viewItems, {
